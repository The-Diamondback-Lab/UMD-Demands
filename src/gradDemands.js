    ...
    return (
      <>
        <div style={{ display: 'flex', width: '100%', justifyContent: 'center' , paddingLeft: '10%', paddingRight: '10%'  }}>
          <Accordion>
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="0" style={{ cursor: 'pointer' , backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'  }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="1" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'  }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="2" style={{ cursor: 'pointer',  backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="3" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'  }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="4" style={{ cursor: 'pointer', backgroundColor: '#e51d37', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row' , justifyContent: 'center' , alignItems: 'center' }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="6" style={{ cursor: 'pointer', backgroundColor: '#e51d37', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'  }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="7" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'  }}>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="8" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon9} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="9" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon10} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="10" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon11} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="12" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon13} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="13" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon14} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="14" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon15} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 8, alignSelf: 'center', fontSize: 20 }}>Divest from the Maryland Correctional Enterprises, as well as businesses and companies invested in it, and the prison industrial complex</div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="15" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon16} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="16" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon17} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="17" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon18} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="18" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon19} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="20" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon21} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="21" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon22} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="22" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon23} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="23" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: 'black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div style={{ flex: .1 }}></div>
                <div style={{ flex: 0.5 }}><img src={icon24} style={{ width: '100%' }} /></div>
              </Accordion.Toggle>
            ...
            <Card>
              <Accordion.Toggle as={Card.Header} eventKey="24" style={{ cursor: 'pointer', backgroundColor: '#E21833', color: 'white', borderColor: '#E21833', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ flex: 0.5 }}><img src={icon25} style={{ width: '100%' }} /></div>
                <div style={{ flex: .1 }}></div>
